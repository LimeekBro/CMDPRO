...
print('\r' + d + d + cl +'―――――――――――――――――――――――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d +d + d + cl +'――――――――――――――――――――――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d + cl +'―――――――――――――――――――――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  cl +'――――――――――――――――――――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  cl +'―――――――――――――――――――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d +  d +  d +  d +  d +  d +  d + cl +'――――――――――――――――――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  cl +'―――――――――――――――――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  cl +'――――――――――――――――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'―――――――――――――――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'――――――――――――――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'―――――――――――――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'――――――――――――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'―――――――――――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'――――――――――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'―――――――――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'――――――――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'―――――――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'――――――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'―――――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d + cl +'――――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'―――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'――――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'―――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'――――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'―――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'――――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'―――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'――――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'――――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'―――', end = '')
time.sleep(0.2)
print('\r' + d + d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  d +  cl +'――', end = '')
time.sleep(0.2)
...
print('\rChecking errors' + Fore.BLUE + '|', end="")
time.sleep(0.2)
print('\rChecking errors' + Fore.BLUE + '', end="")
time.sleep(0.2)
print('\rChecking errors' + Fore.BLUE + '|', end="")
